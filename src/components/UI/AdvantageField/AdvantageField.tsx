...
import styles from "./AdvantageField.module.scss";

type Props = {
	onRemove: () => void;
};

const AdvantageField = React.forwardRef(
	({ onRemove, ...props }: Props, ref: React.ForwardedRef<HTMLInputElement>) => {
		return (
			<div className={styles["advantage-field-wrapper"]}>
				<Input
					type="text"
					ref={ref}
					{...props}
